package com.example.de05.Database;
...
public class SachDB extends SQLiteOpenHelper {
    ...
    public void CreateSampleData (){
        if (getNumbOfRow() == 0 ){
            execSql("INSERT INTO " + TABLE_NAME + " VALUES(null, 'Con ga',39000)");
            execSql("INSERT INTO " + TABLE_NAME + " VALUES(null, 'Con heo',40000)");
            execSql("INSERT INTO " + TABLE_NAME + " VALUES(null, 'Con Lien',30000)");
        }
    }
